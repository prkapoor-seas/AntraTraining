...
SELECT ProductID, Name + ' ' + Color AS NameColor, ListPrice FROM Production.Product WHERE Color IS NOT NULL

-- 7. Write a query that generates the following result set  from Production.Product:
SELECT Name, Color FROM Production.Product WHERE Name LIKE '%Crankarm' OR Name LIKE 'Chainring%' ORDER BY ProductID
